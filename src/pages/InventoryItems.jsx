        ...
        <table className="w-full">
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr><td colSpan={7} className="p-6 text-center">No items found.</td></tr>
            ) : (
              items.map((item) => (
                <tr key={item.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="text-sm">
                    <button onClick={() => openEdit(item)} className="text-blue-600 mr-2">
                      <Edit3 size={15} />
                    </button>
                    <button
                      onClick={() => {
          ...
          <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-xl">
            ...
            >
              <input
                ...
                required
              />
              <button type="submit" className="bg-primary text-white px-3 py-2 rounded text-sm">
                Add
              </button>
            </form>
            <button
              onClick={() => setShowCatForm(false)}
              className="mt-4 border px-4 py-2 rounded text-sm w-full"
            >
              Close
            </button>
          </div>
